        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="block w-7 text-xs">{cartProduct.quantity}</p>
                        <Button
                            size="icon"
                            className="h-7 w-7"
                        >
            ...
            {/* BOTÂO DE DELETAR */}
            <Button size="icon" className="h-8 w-8 border-solid border-muted-foreground" variant="ghost" onClick={handleRemoveClick}>
                <TrashIcon size={18}/>
            </Button>
        </div>
    );
